## Caching the Inverse of a Matrix: In running what can be costly time consuming computations,
##such as matrix inversions, it's beneficial to have the means to cache the results rather
## than repeatedly compute the inverse. 

## The following pair of functions compute and cache the inverse of a matrix by creating a 
## special object which first stores a matrix and then caches its inverse.
